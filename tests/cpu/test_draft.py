...
def config():
    return dict(architectures=['DFlashDraftModel'], model_type='qwen3',
        dflash_config=dict(block_size=4, mask_token_id=30, target_layer_ids=[0, 2]),
        hidden_size=8, intermediate_size=12, head_dim=4, num_attention_heads=2,
        num_key_value_heads=1, num_hidden_layers=2, rms_norm_eps=1e-6,
        layer_types=['sliding_attention', 'full_attention'], sliding_window=3,
